...
Hosted CI on the base checkpoint separately reports failures in Python tests, blocking Ruff enforcement and Windows-footgun checks ([run 35051613810](https://github.com/rayopay/hermes-agent/actions/runs/35051613810)). Their cause and downstream/baseline attribution remain under investigation; local bounded results do not waive them. Owner-positive executable qualification, final integration/release assessment, fresh exact-head CI/review and deployment remain outstanding. No installed runtime, profile or live-card state changed.
